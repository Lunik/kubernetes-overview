...
;(function () {
  ...
  function prepareD3 (cluster) {
    ...
    for (var n in cluster.nodes) {
      ...
      DIAGRAM.nodeIndex[n] = DIAGRAM.nodeIndex[n] ? DIAGRAM.nodeIndex[n] : data.nodes.length - 1
    ...
    for (var ns in cluster.namespaces) {
      ...
      DIAGRAM.nodeIndex[ns] = DIAGRAM.nodeIndex[ns] ? DIAGRAM.nodeIndex[ns] : data.nodes.length - 1
      ...
      for (var svc in cluster.namespaces[ns].services) {
        ...
        DIAGRAM.nodeIndex[ns+'-'+svc] = DIAGRAM.nodeIndex[ns+'-'+svc] ? DIAGRAM.nodeIndex[ns+'-'+svc] : data.nodes.length - 1
        ...
        for (var p in cluster.namespaces[ns].services[svc].pods) {
          ...
          DIAGRAM.nodeIndex[ns+'-'+svc+'-'+p] = DIAGRAM.nodeIndex[ns+'-'+svc+'-'+p] ? DIAGRAM.nodeIndex[ns+'-'+svc+'-'+p] : data.nodes.length - 1
          data.links.push({
  ...
  setInterval(redrawDiagram, 5000)
})()
